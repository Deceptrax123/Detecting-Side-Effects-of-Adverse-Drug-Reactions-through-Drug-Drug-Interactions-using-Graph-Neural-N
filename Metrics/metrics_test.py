...
from torchmetrics.classification import MultilabelPrecision, MultilabelF1Score, MultilabelAccuracy, MultilabelAUROC
import numpy as np
import torch
...
def classification_metrics(predictions, labels):
    ...
    area = MultilabelAUROC(num_labels=1317, average='micro')
    ...
    return label_accuracy, f1_micro, prec, auroc
